...
<body>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_expert">
                        ...
                        <div class="experts_name text-center">
                            ...
                            <a class="" href="howitworks.php"> <span >[Especializaacion]</span></a>
    ...
    <div class="quality_area">
        <div class="container">
            <h1 class="text-center"> Historia Profesional </h1>
            <br>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="dept_info">
                        <h3 class="text-center text-align">Historial medico  <br> scaler near patient</h3 ><br>
