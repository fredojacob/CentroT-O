                            ...
                            <div class="menu_wrap d-none d-lg-block">
                                <div class="menu_wrap_inner d-flex align-items-center justify-content-end">
                                    <div class="main-menu">
                                        <nav>
                                            <ul id="navigation">
                                                <li><a href="enviar_pruebas.php">Inicio</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3> <span>TYO</span> <br>
                                    Cuida la salud de tu familia</h3>
                                    <span>La mejor atención medica </span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_docmed_info">
                        <h3>Bievenido a la
                            <span>Clinica Virtual </span></h3>
                        <p>Este es un espacio virtual donde puedes realizar tus consultas sin necesidad de salir de tu casa </p>
                        <ul>
                            <li> <i class="flaticon-verified"></i> Crea tu cita Online </li>
                            <li> <i class="flaticon-verified"></i> Puedes ser atendido via remota</li>
                            <li> <i class="flaticon-verified"></i> Comunicate con nosotros en nuestras redes sociales  </li>
                        </ul>
                        <a href="about.html" class="boxed-btn6">Nosotros </a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center ">
                <div class="col-lg-6">
                    <div class="section_title mb-55 text-center">
                        <h3>Nosotros</h3>
                        <p>Este es una breve descripcion de quienes somos nosotros </p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="whole-wrap">
        <div class="container box_1170">
          <!--   <div class="section-top-border text-right">
                <h3 class="mb-30">[Nombre de la foto]</h3>
                <div class="row">
                    <div class="col-md-9">
            ...
            <div class="section-top-border">
                <h3 class="mb-30">[Area de NOTAS]</h3>
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="single_emergency">
                            ...
                            <div class="info_button">
                                <a href="#" class="boxed-btn3-white">ingresa a nuestro blog
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="single_emergency align-items-center d-flex justify-content-end">
                            ...
                            <div class="info">
                                <span>LLAMA AL SIGUIENTE NUMERO</span>
                                <h3>+502 5431-8727</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4  col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <ul class="meting_time">
                                <li class="d-flex justify-content-between "><span>Lunes - Viernes</span> <span>08.00am - 18.00pm</span></li>
                                <li class="d-flex justify-content-between "><span>Sabado	</span> <span>08.00am - 18.00pm</span></li>
                                <li class="d-flex justify-content-between "><span>Domingo   </span> <span>08.00am - 13.00</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            <p lass="text-center text-align-center"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |<i class="" aria-hidden="true"></i> by <a href="http://www.curriculumvitae.com.s3-website-us-east-1.amazonaws.com/" target="_blank"> Ing. Freddy Gonzalez</a>
                        </p>
                    </div>
                </div>
            </div>
